...
class MesaExamen {
    ...
    public function crear() {
        if (($this->primerLlamado || $this->segundoLlamado) && $this->tribunal) {
            ...
            $consulta = "INSERT INTO mesa_examen (id, idPrimerLlamado, idSegundoLlamado, idTribunal, fechaCreacion, observacion) VALUES (NULL, {$primero}, {$segundo}, {$tribunal}, NOW(), '{$this->observacion}')";
