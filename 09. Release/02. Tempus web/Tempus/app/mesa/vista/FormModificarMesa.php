                ...
                <div class="card border-dark mb-2" title="Las modificaciones sobre el tribunal no generan alertas en la APP">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col mb-2">
                                <select class="form-control mb-2 tribunal"  data-width="100%"  name="presidente" id="presidente">
                            ...
                            <div class="col mb-2">
                                <select class="form-control mb-2 tribunal"  data-width="100%"  name="vocal1" id="vocal1">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col mb-2">
                                <select class="form-control mb-2 tribunal"  data-width="100%"  name="vocal2" id="vocal2">
                                     <option value="' . $idVocal2 . '">' . $nombreVocal2 . '</option>
                                </select>
                            </div>
                            <label for="suplente" class="col-sm-2 col-form-label">Suplente:</label>
                            <div class="col mb-2">
                                <select class="form-control mb-2 tribunal"  data-width="100%"  name="suplente" id="suplente">
