...
if ($_POST['peticion'] || !isset($_SESSION['BUSCAR_MESA'])) {
    ...
    $_SESSION['BUSCAR_MESA'] = array($nombreCarrera, $nombreAsignatura);
} else {
    if (isset($_SESSION['BUSCAR_MESA'])) {
        /* SE INGRESO AL FORMULARIO Y HAY UNA BUSQUEDA ALMACENADA */
        $parametros = $_SESSION['BUSCAR_MESA'];
    ...
    if ($cantidadLlamados > 0) {
        ...
        if ($cantidadLlamados == 1) {
                        ...
                        <td class='text-center'>
                            <div class='btn-group btn-group-sm'>
                                ...
                                <button class='btn btn-outline-info detalle' 
                                        name='{$idPlan}' 
                                        title='Detalle: {$nombreLargoCarrera} {$nombreLargoAsignatura}'>
            ...
            foreach ($mesas as $mesa) {
                ...
                $fechaSL = ($mesa['fechaSegundoLlamado']) ? date_format(date_create($mesa['fechaSegundoLlamado']), 'd/m/Y') : '';
