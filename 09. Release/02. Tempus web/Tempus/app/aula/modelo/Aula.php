...
class Aula
{
    ...
    /** @var string Fecha de cracion del registro. */
    private $fechaCreacion;

    /** @var array Listado de clases asociadas al aula. */
    private $clases;

    /** @var array Listado de mesas de examen asociadas al aula. */
    private $mesas;
    ...
    public function crear()
    {
        if ($this->nombre && $this->sector) {
            $consulta = "INSERT INTO aula (id, nombre, sector, fechaCreacion) VALUES (NULL, '{$this->nombre}', '{$this->sector}', NOW())";
