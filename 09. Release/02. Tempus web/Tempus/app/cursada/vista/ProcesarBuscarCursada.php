...
if ($_POST['peticion'] || !isset($_SESSION['BUSCAR_CURSADA'])) {
    ...
    $_SESSION['BUSCAR_CURSADA'] = array($nombreCarrera, $nombreAsignatura);
} else {
    if (isset($_SESSION['BUSCAR_CURSADA'])) {
        /* SE INGRESO AL FORMULARIO Y HAY UNA BUSQUEDA ALMACENADA */
        $parametros = $_SESSION['BUSCAR_CURSADA'];
...
if ($resultado[0] == 2) {
    ...
    foreach ($cursadas as $cursada) {
        ...
        $totalClases = ($cursada['horaInicioLunes']) ? $totalClases + 1 : $totalClases;
        ...
        $totalClases = ($cursada['horaInicioMartes']) ? $totalClases + 1 : $totalClases;
        ...
        $totalClases = ($cursada['horaInicioMiercoles']) ? $totalClases + 1 : $totalClases;
        ...
        $totalClases = ($cursada['horaInicioJueves']) ? $totalClases + 1 : $totalClases;
        ...
        $totalClases = ($cursada['horaInicioViernes']) ? $totalClases + 1 : $totalClases;
        ...
        $totalClases = ($cursada['horaInicioSabado']) ? $totalClases + 1 : $totalClases;

        $agregarDisabled = '';
        if ($totalClases == 6) {
            $agregarDisabled = 'disabled';
        }
        $filas .= "
            <tr>
                ...
                <td class='text-center'>
                    <div class='btn-group btn-group-sm'>
                        ...
                        <button class='btn btn-outline-success agregar' 
                                name='$idPlan' id='$idPlan' $agregarDisabled
                                title='Agregar clase: {$nombreLargoCarrera} {$nombreLargoAsignatura}'>
            ...
            <div class="col text-right">
                <div class="btn-group">
                    <button class="btn btn-outline-dark dropdown-toggle"
                            ...
                            <i class="fas fa-tasks"></i> Columnas
                    </button>
