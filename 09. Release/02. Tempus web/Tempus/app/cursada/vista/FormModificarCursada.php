        ...
        for ($dia = 1; $dia < 7; ++$dia) {
            ...
            if ($clase) {
                ...
                $cbBorrar = '<input type="checkbox" class="borrarClases" 
                               ...
                               value="' . $dia . '">';
                $cbEditar = '<input type="checkbox" class="clases" 
                                    id="cbClases" name="cbClases[]" 
                                    value="' . $dia . '">';

                $filas .= '
                    <tr name="' . $dia . '">
                        <input type="hidden" name="idClase' . $dia . '" id="idClase' . $dia . '" value="' . $idClase . '">
                        <td class="align-middle text-center">' . $cbEditar . '</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" id='btnConfirmarEliminacion' name='btnConfirmarEliminacion' title='Confirmar la eliminación del registro seleccionado'>
                        <i class="far fa-save"></i> GUARDAR</button>
                    <input type='submit' class='btn btn-outline-secondary' id='btnCancelarEliminacion' name="btnCancelarEliminacion" data-dismiss="modal" title='Cancelar la eliminación del registro seleccionado' value='Cancelar'>
                </div>
            </div>
        </div>
    </div>
