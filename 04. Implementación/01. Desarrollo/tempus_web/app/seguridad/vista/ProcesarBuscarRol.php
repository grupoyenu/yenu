            ...
            <table id="tablaBuscarRoles" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th title="Cantidad total de usuarios asociados">Total de usuarios asociados</th>
                        <th title="Cantidad total de permisos asociados">Total de permisos asociados</th>
