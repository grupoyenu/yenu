...
if (isset($_POST['idAula'])) {
    ...
    if ($datosAula[0] == 2) {
        ...
        if ($datosClase[0] == 2) {
            ...
            $codigo = $datosClase[0];
            $mensaje = $datosClase[1];
            $alerta = ControladorHTML::mostrarAlertaResultadoOperacion($codigo, $mensaje);
            $formulario .= '
                <div class="card border-dark mb-2 mt-2">
                    <div class="card-header bg-dark text-white">Horarios de clase</div>
                    <div class="card-body">' . $alerta . '</div>
                </div>';
        }
