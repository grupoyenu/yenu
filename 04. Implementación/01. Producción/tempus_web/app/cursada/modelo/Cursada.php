...
class Cursada {
    ...
    public function borrar() {
        if (count($this->clases) > 0) {
            ...
            if ($resultado) {
                return array(2, "Se realizó la eliminación de la cursada correctamente");
            }
            return array(1, "No se realizó la eliminación de la cursada porque no se eliminaron todas las clases");
        }
