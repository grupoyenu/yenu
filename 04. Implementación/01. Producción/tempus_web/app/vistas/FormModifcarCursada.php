 ...
 * modificacion de una cursada. El mismo contiene la informacion modificable de 
 * una cursada junto con los datos particulares de la cursada seleccionada durante 
 * la busqueda. Los eventos de esta pantalla son controlados por el archivo 
 * ModificarCursada.js y se comunica a traves de una solicitud AJAX con el 
 * archivo procesaModificarCursada.php. Ademas, hace la inclusion de los modales 
...
<div class="container">
    ...
    <div id="contenido">
        <form method="POST" id="formModificarCursada" name="formModificarCursada">
            <?php
...
?>
<script type="text/javascript" src="./app/js/ModificarCursada.js"></script>