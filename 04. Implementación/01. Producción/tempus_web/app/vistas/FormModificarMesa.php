<?php
/* 
 * Este archivo es el que visualiza por pantalla el usuario al solicitar la 
 * modificacion de una mesa. El mismo contiene la informacion modificable de una 
 * mesa junto con los datos particulares de la mesa seleccionada durante la busqueda. 
 * Los eventos de esta pantalla son controlados por el archivo ModificarMesa.js 
 * y se comunica a traves de una solicitud AJAX con el archivo procesaModificarMesa.php. 
 * Ademas, hace la inclusion de los modales que permiten la selección de planes, 
 * docentes y aulas.
 */
...
<div class="container">
    <h4 class="text-center p-4">MODIFICAR MESA DE EXAMEN</h4>
        ...
        if (is_null($planes) || empty($planes)) {
            ...
            if (is_null($aulas) || empty($aulas)) {
                ...
                if (is_null($docentes) || empty($docentes)) {
                    ...
                    echo '
                    <form id="formModificarMesa" name="formModificarMesa" method="POST">
...
?>
<script type="text/javascript" src="./app/js/ModificarMesa.js"></script>