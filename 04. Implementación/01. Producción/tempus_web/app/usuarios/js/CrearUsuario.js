...
$(document).ready(function () {
    ...
    $('#formCrearUsuario').submit(function (evento) {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "./app/usuarios/vistas/ProcesarCrearUsuario.php",
    ...
    $('#correo').change(function () {
        ...
        if ($("#metodo").val() === "Google") {
            if (!correo.includes('@unpa.edu.ar') && !correo.includes('@gmail.com')) {
                var mensaje = "Para metodo 'Google' se debe indicar un correo @unpa.edu.ar o @gmail.com";
                var div = '<div class="alert alert-warning text-center" role="alert"><strong>' + mensaje + '</strong></div>';
