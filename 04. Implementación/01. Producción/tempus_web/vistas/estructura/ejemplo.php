            	...
            	<section id="main-content">
            		<article>
            			<div class="content">
            				...
            				<h4>Gestión de Horarios de Cursada y Mesas de Examen</h4>
            				<fieldset>
            					<legend>Estimado usuario</legend>
                                 ...
                                 <h6 class="letraVerde">Ingreso al Sistema</h6>
                                 <h6 class="letraNaranja">Ingreso al Sistema</h6>
                                 <h6 class="letraRoja">Ingreso al Sistema</h6>
                                 
                                 <br>
                                 <label class="centrado">Class centrado:</label>
                                 <input type="text">
