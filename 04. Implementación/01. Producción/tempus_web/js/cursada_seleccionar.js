 ...
 * para seleccionar un archivo de cursadas, antes que sea enviado al servidor.
...
$(document).ready(function() {
	...
	$('form#formSeleccionarCursadas').submit(function() {	
		
		$("h3#mensaje" ).remove();
		var archivo = $('input#fileCursadas').val();
		...
		if( document.getElementById("fileCursadas").value.toLowerCase().lastIndexOf(".csv") == -1) {
